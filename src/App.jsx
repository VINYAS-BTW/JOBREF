...
export default function App() {
  ...
  return (
    <div
      className="min-h-screen text-[#E8E6E1]"
      style={{
    ...
    >
      <AnimatePresence mode="wait">
        ...
        {view === "auth" && (
          <AuthPage key="auth" mode={authMode} navigate={navigate} />
        )}
        {view === "candidate" && (
          <CandidateDashboard key="candidate" navigate={navigate} />
        )}
        {view === "employee" && (
          <EmployeeDashboard key="employee" navigate={navigate} />
        )}
        {view === "hiring" && (
          <HiringDashboard key="hiring" navigate={navigate} />
        )}
      </AnimatePresence>
    </div>
  );
